...
let messages = [
    { email: "bot@gmail.com", date: moment().format('LLLL'), messageData: "¡Hola! ¿Que tal?" },
    { email: "bot@gmail.com", date: moment().format('LLLL'), messageData: "¿Alguno de ustedes necesitan ayuda?" }
];
